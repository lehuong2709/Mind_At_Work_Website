...
Author: Jai Moondra
Date: 2024-02-15
Description: This script contains the FacilitiesDataHandler class, which is used to handle data for existing facilities
in the US.
"""
...
class FacilitiesDataHandler:
    ...
    def __reduce__(self):
        return FacilitiesDataHandler, (self.name, self.full_data_file_path, self.abridged_data_file_path, self.type,
                                       self.display_name, self.description, self.color, self.distance_label,
                                       self.description, self.voronoi_folder)
    ...
    def _get_abridged_data_file_path(self):
        ...
        return os.path.join('data', 'usa', 'existing_facilities', self.name, 'abridged_facilities.csv')
    ...
    def read_abridged_facilities(self):
        ...
        try:
            ...
            facilities = pd.read_csv(self.abridged_data_file_path)
