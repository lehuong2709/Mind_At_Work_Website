...
st.sidebar.write(':orange[Currently unoptimized and may take a few seconds to load. Preliminary results only. No legal claims.]')

# st.sidebar.write('Created by Jai Moondra.
# Major parts of the code by Michael Wang, Hassan Mortagy, and Swati Gupta.
# Some parts of the code were generated by ChatGPT and Google Bard.')
