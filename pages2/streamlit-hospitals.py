...
st.sidebar.write(r'Let\'s define a **medical desert** as a US census blockgroup that is more than $n$ miles away from '
                 r'an hospitals and with over $p$% of the population living below the poverty line.')
...
st.markdown("""
    ...
    <h3 style="font-size: 18px; text-align: center; margin-top: 0em;">
        Based on <span style="color: #c41636">hospitals</span>
    </h3>
    <br>
...
show_pharmacies = st.sidebar.checkbox('Show hospital locations', value=False)
