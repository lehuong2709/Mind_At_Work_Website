...
from src.usa.facilities_data_handler import CVS, Walgreens, Walmart
...
#     st.text("This is a detailed explanation or footnote that elaborates on the statement.")
...
st.markdown("""
    ...
    <h3 style="font-size: 18px; text-align: center; margin-top: 0em;">
        Based on <span style="color: #c41636">pharmacy distances</span>
    </h3>
    <br>
    """, unsafe_allow_html=True)

blockgroup_url = "https://en.wikipedia.org/wiki/Census_block_group"
st.markdown("Let's define a **medical desert** as a US census blockgroup that is more than n miles away from a CVS/Walgreeens/Walmart pharmacy and with over p% of the population living below the poverty line.")
